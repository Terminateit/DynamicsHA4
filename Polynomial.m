function [qd,vd,ad] = Polynomial(t_IF,q_IF, qdot_IF, qdotdot_IF, n)
    ...
    elseif n == 21
        ...
        ad = subs(q_dotdot,{a0, a1, a2}, {a(1), a(2), a(3)});
    elseif n == 5
        q = a0+a1*t+a2*t^2+a3*t^3+a4*t^4+a5*t^5; %polynomial equation

        q_dot = diff(q,t);
        q_dotdot = diff(q_dot,t);

        % Solution: 
        M = [ 1 t_IF(1) t_IF(1)^2 t_IF(1)^3 t_IF(1)^4 t_IF(1)^5;
        0 1 2*t_IF(1) 3*t_IF(1)^2 4*t_IF(1)^3 5*t_IF(1)^4;
        0 0 2 6*t_IF(1) 12*t_IF(1)^2 20*t_IF(1)^3;
        1 t_IF(2) t_IF(2)^2 t_IF(2)^3 t_IF(2)^4 t_IF(2)^5;
        0 1 2*t_IF(2) 3*t_IF(2)^2 4*t_IF(2)^3 5*t_IF(2)^4;
        0 0 2 6*t_IF(2) 12*t_IF(2)^2 20*t_IF(2)^3;];

        b = [q_IF(1); qdot_IF(1); qdotdot_IF(1); ...
            q_IF(2); qdot_IF(2); qdotdot_IF(2)];

        a = inv(M)*b;

        %desired a, velocity and acceleration
        qd = subs(q,{a0, a1, a2, a3, a4, a5}, {a(1), a(2), a(3), a(4), a(5), a(6)});
        vd = subs(q_dot,{a0, a1, a2, a3, a4, a5}, {a(1), a(2), a(3), a(4), a(5), a(6)});
        ad = subs(q_dotdot,{a0, a1, a2, a3, a4, a5}, {a(1), a(2), a(3), a(4), a(5), a(6)});
    elseif n == 21
        q = a0+a1*t+a2*t^2; %polynomial equation
